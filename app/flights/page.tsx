  ...
  return (
    <>
      ...
      <TravelHero
        ...
        heading="Compare Flights Worldwide"
        description="Search hundreds of airlines and find the best fares — then book directly with the airline."
        height="md"
      />
      ...
      <section className="py-16 bg-sand">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-end justify-between mb-8">
            <div>
              <SectionHeading align="left" heading="Popular Routes" eyebrow="Inspiration" />
