...
export default function NewsForm({ initialData, countries, destinations, authors }: NewsFormProps) {
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  {author.id && !authors.find(a => a.id === author.id) && (
                    <option value={author.id}>{author.name || 'Legacy Author'} (Legacy)</option>
                  )}
                </select>
              </div>
