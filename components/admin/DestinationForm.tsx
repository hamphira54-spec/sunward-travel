...
interface DestinationFormProps {
  initialData?: any;
  countries: { slug: string; name: string; continent: string; region: string }[];
}
    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link
          ...
          className="text-[#76675D] hover:text-[#2B221C] text-sm font-medium transition-colors"
        >
          Cancel
        </Link>
      </div>
